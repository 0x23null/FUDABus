...
<head>
    ...
    <title>Dang nhap - BusTicket</title>
...
<body class="fade-in">
    <div class="auth-container">
        <div class="glass-panel auth-card">
            ...
            <h2 class="auth-title">Dang nhap tai khoan</h2>
            ...
            <div style="margin-top: 20px; font-size: 14px; color: var(--text-secondary);">
                Chua co tai khoan? <a href="register" style="color: var(--primary-color);">Dang ky ngay</a>
            </div>
